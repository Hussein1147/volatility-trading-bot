...
async def main():
    ...
    if main_running:
        ...
        if launch_dashboard('scripts/production/run_dashboard.py', 8501, "Main Dashboard"):
            verifier.checks_passed += 1
        else:
    ...
    if backtest_running:
        ...
        if launch_dashboard('scripts/production/run_backtest.py', 8502, "Backtest Dashboard"):
            verifier.checks_passed += 1
        else:
            verifier.checks_failed += 1
